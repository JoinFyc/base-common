...
public class HashUtil {
     ...
     */
    public static byte[] sha1(byte[] input, @Nullable byte[] salt) {
     ...
     * 对输入字符串进行sha1散列，带salt达到更高的安全性.
     */
    public static byte[] sha1(String input, @Nullable byte[] salt) {
     ...
     */
    public static byte[] sha1(byte[] input, @Nullable byte[] salt, int iterations) {
     ...
     * @see #generateSalt(int)
     */
    public static byte[] sha1(String input, @Nullable byte[] salt, int iterations) {
